...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   var resultdao = numeroMisterioso*5;
   return resultdao;
...
var objetoUsuario = { amigos: "diego"}
console.log(agregarAmigo(objetoUsuario, "pepe"));
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.calcularPrecioDescuento = function () {
      ...
      var precioT = objetoProducto.precio - descuento;
      return precioT;
   }
